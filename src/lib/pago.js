...
/* ============================================================
   ...
   A lista de compras fica guardada no aparelho, senão o app sem
   rede acharia que ninguém comprou nada e trancaria o que já
   foi pago. Os links vêm do lib/links.
   ============================================================ */
...
export async function carregarCompras() {
  ...
  try {
    const compras = await supabase.rpc('minhas_compras');
